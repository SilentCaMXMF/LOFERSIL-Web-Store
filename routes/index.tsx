  ...
  const { user } = data;
   return (
        <div class="min-h-screen bg-gray-100 pt-24">
         ...
         <header class="fixed top-0 left-0 right-0 z-50 bg-slate-800 bg-opacity-80 backdrop-blur-sm shadow-lg">
           <nav class="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between" role="banner" aria-label="Main site navigation">
             ...
             <a href="/" class="flex items-center space-x-2" aria-label="LOFERSIL home">
                <div class="image-container">
                  <img src="/static/images/frente-loja.jpg" alt="LOFERSIL store front" class="w-6 h-6 rounded-full object-cover image" loading="lazy" />
                </div>
              ...
              <div class="hidden md:flex space-x-6">
                <a href="#about" class="text-white hover:text-gray-200 focus:text-gray-200 focus:outline-none focus:ring-2 focus:ring-white rounded px-2 py-1 transition-colors">About</a>
           ...
           <section class="hero py-16 md:py-32 px-4">
             <div class="max-w-6xl mx-auto text-center">
               <div class="image-container">
                 <img src="/static/images/frente-loja.jpg" alt="LOFERSIL store front" class="w-24 h-24 md:w-32 md:h-32 mx-auto mb-6 md:mb-8 rounded-full shadow-lg image" loading="lazy" />
               </div>
               <h1 class="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6">LOFERSIL Office Supplies</h1>
               <p class="text-lg md:text-xl lg:text-2xl opacity-90 mb-6 md:mb-8">Your trusted source for all office needs</p>
               <div class="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4">
                 {user ? (
                   <>
                     <span class="text-lg md:text-xl">Welcome, {user.email}</span>
           ...
           <section class="section bg-gray-50">
             <div class="max-w-6xl mx-auto">
               <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 md:mb-12 text-center text-slate-700">Our Features</h2>
               <div class="grid-container">
                 <div class="card text-center">
                   <div class="image-container">
                     <img src="/static/images/interior-funcionario.jpg" alt="Interior with employee" class="w-12 h-12 md:w-16 md:h-16 mx-auto mb-4 image" loading="lazy" />
                   </div>
                   <h3 class="text-xl md:text-2xl font-semibold mb-4 text-slate-700">Expert Team</h3>
                   <p class="text-base md:text-lg">Meet our dedicated staff, always ready to assist you with expert advice and friendly service.</p>
                 </div>
                 <div class="card text-center">
                   <div class="image-container">
                     <img src="/static/images/interior.jpg" alt="Store interior" class="w-12 h-12 md:w-16 md:h-16 mx-auto mb-4 image" loading="lazy" />
                   </div>
                   <h3 class="text-xl md:text-2xl font-semibold mb-4 text-slate-700">Organized Interior</h3>
                   <p class="text-base md:text-lg">Explore our well-organized store interior, designed for easy browsing and a pleasant shopping experience.</p>
                 </div>
                 <div class="card text-center">
                   <div class="image-container">
                     <img src="/static/images/frente-loja.jpg" alt="Store front" class="w-12 h-12 md:w-16 md:h-16 mx-auto mb-4 image" loading="lazy" />
                   </div>
                   <h3 class="text-xl md:text-2xl font-semibold mb-4 text-slate-700">Prime Location</h3>
                   <p class="text-base md:text-lg">Conveniently located in the business district for easy access to all your office supply needs.</p>
                 </div>
               </div>
             </div>
           </section>
         ...
         {/* About Us */}
          <section class="section bg-gray-50" aria-label="About us section">
           <div class="max-w-4xl mx-auto text-center">
             <h2 class="text-4xl md:text-5xl font-bold mb-6 text-slate-700">About Us</h2>
             <p class="text-xl leading-relaxed">
               Founded in 2023, LOFERSIL has been serving the community with
         ...
         {/* Contact Information */}
          <section class="section bg-white" aria-label="Visit us section">
           <div class="max-w-4xl mx-auto text-center">
             <h2 class="text-4xl md:text-5xl font-bold mb-6 text-slate-700">Contact Us</h2>
             <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
               <div class="card">
